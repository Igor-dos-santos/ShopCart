...
# import cart items from views file
        ...
        if user is not None:
            ...
            try:                
                ...
                if is_cart_item_exists:
                    ...
                    # getting the product variation by cart id (cart_item)
                    product_variation = []
                    for item in cart_item:
                        variation = item.variations.all()
                        product_variation.append(list(variation))

                    # Get the cart items from the user to access their products variations
